...
def bin_data(all_arena_positions: dict[int, NDArray], scale: float = 2.5) -> NDArray:
...
def points_in_bin(points: NDArray, bins: NDArray, scale: float = 2.5) -> NDArray:
